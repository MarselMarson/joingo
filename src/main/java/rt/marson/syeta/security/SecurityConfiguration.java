    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/auth/**", "/confirm/**", "/confirm-password-reset/**").permitAll()
                        .requestMatchers("/const/**", "/countries/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/event/*").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/event/archived/*").permitAll()
